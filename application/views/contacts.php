...
<div id="mainframe">
	<div>
			...
			<div id="valign" class="row-same-height">
				<div class="row-same-height col-md-height col-middle text-center">
					<span class="subhead">Контакты</span><br>
					<img src="<?=base_url('img/yolo-line.png')?>">
					<p><span class="glyphicon glyphicon-earphone"></span>&nbsp;+38 (067) 123-45-67, +38 (093) 123-45-67</p>
					<p><span class="glyphicon glyphicon-envelope"></span>&nbsp;yolokiev@gmail.com</p>
