...
<?php 
	$attributes = array('class' => 'form checkout mensclub', 'style' => 'height: 100%; margin-top: 1%;');
	echo form_open(site_url('page/checkout'), $attributes) ?>
		...
		<div class="form-group col-sm-12" style="height: 10%;">
			<div class="col-sm-2  col-sm-offset-5">
				<button class="btn btn-yolo btn-lg">Оформить заказ  <span class="glyphicon glyphicon-ok"></span></button>
			</div>
		</div>
